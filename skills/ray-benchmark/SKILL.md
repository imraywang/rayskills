...
这个 skill 是我们自己拆竞品的复盘固化下来的:把一个开源中转项目拆成能收钱的 Upthos Relay、把对标的内容账号拆开给自己的 X 打法找差异位。每次拆完最痛的教训都是同一条——**抄错了不可迁移的东西,等于拿着别人的运气当自己的方法。**
...
- 想诊断的是**自己**的业务哪里出了问题、能不能上某个项目——那是就绪度诊断,用 `/ray-diagnose`
