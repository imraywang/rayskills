...
| 关 | 过滤问题 | 劝退 / 降级判据 |
|---|---|---|
| **① 同赛道** | 它的成功逻辑所在赛道,和你要打的赛道,底层机制相通吗?**同赛道还要同市场阶段**:它的机制成功于早期市场(卖愿景给尝鲜者)还是主流市场(卖完整方案给实用主义者)? | 跨赛道抄打法常水土不服(To C 网红打法搬到 To B 必崩)。机制不通→降级。阶段错配(《跨越鸿沟》)→降级:早期市场打法搬到主流阶段、或反之,机制再好也失效 |
